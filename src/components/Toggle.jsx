...
export function Toggle({ enabled, label, onChange }) {
    ...
    return (<Pressable accessibilityLabel={label} accessibilityRole="switch" accessibilityState={{ checked: enabled }} hitSlop={theme.spacing.sm} onPress={() => onChange(!enabled)} style={{ opacity: 1 }}>
      <View style={{
