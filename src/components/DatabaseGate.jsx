...
export function DatabaseGate({ children }) {
    ...
    const [initializationState, setInitializationState] = useState("loading");
    ...
    return (<SafeAreaView style={{ flex: 1, backgroundColor: theme.colors.bg }}>
      <View style={{ alignItems: "center", flex: 1, justifyContent: "center", paddingHorizontal: theme.spacing.top }}>
        {initializationState === "loading" ? (<View accessible accessibilityRole="progressbar" style={{ alignItems: "center", gap: theme.spacing.xl }}>
          ...
          </View>) : (<View accessible accessibilityRole="alert" style={{ alignItems: "center", gap: theme.spacing.xl, maxWidth: theme.sizes.maxContentWidth, width: "100%" }}>
