...
export function PrimaryButton({ children, disabled = false, onPress, style }: ButtonProps) {
...
export function DashedButton({ children, disabled = false, onPress, style }: ButtonProps) {
  const theme = useTheme();
