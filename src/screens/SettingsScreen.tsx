...
export function SettingsScreen({ navigation }: SettingsProps) {
  ...
  const cycleCurrency = () => {
    ...
    const index = options.indexOf(currencySymbol as (typeof options)[number]);
    ...
    <ScreenContainer contentContainerStyle={{ gap: theme.spacing.xl }} testID="settings-screen">
      ...
      <SettingsSection title="SECURITY">
        <SettingsRow
          ...
          trailing={
            <Toggle
              enabled={appLockEnabled && hasPin}
              label="App lock"
              onChange={(enabled) => void handleAppLockToggle(enabled)}
            />
          }
        />
      ...
      <SettingsSection title="DATA">
        ...
        <SettingsRow
          ...
          onPress={() => navigation.navigate("PasteImport", { mode: "backup" })}
          trailing={trailingText("›")}
        />
        <SettingsRow
          emoji="📥"
          label={"Import data (CSV/\nExcel)"}
          onPress={() => navigation.navigate("PasteImport", { mode: "csv" })}
          trailing={trailingText("›")}
        />
      </SettingsSection>
        ...
        <SettingsRow
          ...
          trailing={
            <Toggle
              ...
              label="Budget-based tips"
              onChange={(enabled) => void setSmartTipsEnabled(enabled)}
            />
          }
        />
        <SettingsRow
          ...
          trailing={
            <Toggle
              ...
              onChange={(enabled) => void setRemindersEnabled(enabled)}
            />
          }
        />
      </SettingsSection>
