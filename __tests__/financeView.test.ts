import {
  ...
  spendingByCategory,
  toMonthYear,
} from "../src/domain/services/financeView";
import type { Account, Budget, Category, RecurringRule, Transaction } from "../src/domain/types";
...
function tx(
  partial: Partial<Transaction> & Pick<Transaction, "id" | "amountMinor" | "type" | "categoryId" | "dateEpochMillis">,
): Transaction {
  return {
    accountId: 1,
    note: null,
